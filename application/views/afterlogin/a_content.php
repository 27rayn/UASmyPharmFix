    ...
    <div class="body container col-xl-10 px-4 py-5">
      <div class="row align-items-center g-5 py-5">
        <div class="col-10 col-sm-8 col-lg-6 ">
          <h1 class="display-5 fw-bold mb-3 headline" style="color: #371be0; font-family: 'Montserrat', sans-serif; font-weight: 700">We are changing the way you buy medicine</h1>
          <p class="lead headline1">
    ...
    <div class="container px-4 py-5">
      <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
        <div class="col d-flex align-items-start">
          <div class="section1 flex-shrink-0 me-3">
            <span class="iconify" data-inline="false" data-icon="ic:baseline-location-on" style="color: #051e76; font-size: 48px"></span>
          </div>
          <div>
            <h2 class="feature" style="color: #051e76; font-size: 24px; font-family: 'Mulish', sans-serif; font-weight: 700">Pharmacy Near You</h2>
            <p class="feature" style="color: #051e76; font-size: 16px; font-family: 'Mulish', sans-serif; font-weight: 400">Get your medicine from the nearest pharmacy from your home.</p>
          </div>
        </div>
        ...
        <div class="col d-flex align-items-start">
          ...
          <div>
            <h2 class="feature" style="color: #051e76; font-size: 24px; font-family: 'Mulish', sans-serif; font-weight: 700">Knock-knock medicine!</h2>
            <p class="feature" style="color: #051e76; font-size: 16px; font-family: 'Mulish', sans-serif; font-weight: 400">Your medicine will knock at your door.</p>
          </div>
        </div>
        ...
        <div class="col d-flex align-items-start">
          ...
          <div>
            <h2 class="feature" style="color: #051e76; font-size: 24px; font-family: 'Mulish', sans-serif; font-weight: 700">24/7 Customer Care</h2>
            <p class="feature" style="color: #051e76; font-size: 16px; font-family: 'Mulish', sans-serif; font-weight: 400">We are 24/7 available for you! Don’t be hesitate to call us.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <section id="deals">
      <div class="container px-4 pb-5">
        <h2 class="deal pb-2" style="color: #051e76; font-size: 32px; font-family: 'Mulish', sans-serif; font-weight: 700">Best Deal</h2>

        <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
          <div class="dealcard col">
